...
function apply(opcodes, opcode_cycles)
  ...
  opcodes[0xDE] = function(self, reg, flags, mem) sbc_from_a(reg, flags, self.read_nn()) end
  ...
  opcodes[0x09] = function(self, reg, flags, mem) add_to_hl(reg, flags, reg.bc()) end
  opcodes[0x19] = function(self, reg, flags, mem) add_to_hl(reg, flags, reg.de()) end
  opcodes[0x29] = function(self, reg, flags, mem) add_to_hl(reg, flags, reg.hl()) end
  opcodes[0x39] = function(self, reg, flags, mem) add_to_hl(reg, flags, reg[2]) end

  -- inc rr
  opcode_cycles[0x03] = 8
  opcodes[0x03] = function(self, reg, flags, mem)
    reg.set_bc(band(reg.bc() + 1, 0xFFFF))
  end

  opcode_cycles[0x13] = 8
  opcodes[0x13] = function(self, reg, flags, mem)
    reg.set_de(band(reg.de() + 1, 0xFFFF))
  end

  opcode_cycles[0x23] = 8
  opcodes[0x23] = function(self, reg, flags, mem)
    reg.set_hl(band(reg.hl() + 1, 0xFFFF))
  end

  opcode_cycles[0x33] = 8
  opcodes[0x33] = function(self, reg, flags, mem)
    reg[2] = band(reg[2] + 1, 0xFFFF)
  end

  -- dec rr
  opcode_cycles[0x0B] = 8
  opcodes[0x0B] = function(self, reg, flags, mem)
    reg.set_bc(band(reg.bc() - 1, 0xFFFF))
  end

  opcode_cycles[0x1B] = 8
  opcodes[0x1B] = function(self, reg, flags, mem)
    reg.set_de(band(reg.de() - 1, 0xFFFF))
  end

  opcode_cycles[0x2B] = 8
  opcodes[0x2B] = function(self, reg, flags, mem)
    reg.set_hl(band(reg.hl() - 1, 0xFFFF))
  end

  opcode_cycles[0x3B] = 8
  opcodes[0x3B] = function(self, reg, flags, mem)
    reg[2] = band(reg[2] - 1, 0xFFFF)
  end

  -- add SP, dd
  opcode_cycles[0xE8] = 16
  opcodes[0xE8] = function(self, reg, flags, mem)
